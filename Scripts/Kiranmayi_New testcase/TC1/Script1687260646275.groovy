...
not_run: WebUI.setText(findTestObject('Quote/Page_HMIC Agency Portal - Personal Umbrella - Account Information/input_ZIP Code_Accinf'), 
    '49503')

not_run: WebUI.click(findTestObject('Accountinfo/Page_HMIC Agency Portal - Personal Umbrella - Account Information/div_Michigan'))
...
not_run: WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_365b9a/div_0010-NiPerry 020590010NickPerry'))
...
not_run: WebUI.click(findTestObject('producer code in accinfo/Page_HMIC Agency Portal - Personal Umbrella - Account Information/div_0002059-0000-HOUSE House Code'))
...
WebUI.setText(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_c196ac/input_Occupation (if retired, list prior oc_83c789'), 
    'engineer')

WebUI.setText(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_c196ac/input_concat(Name of Insured, , s Employer)_cfa305'), 
    'test')

WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_c196ac/div_None'))

WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_c196ac/div_APEX'))

WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_c196ac/span_Next Primary Policy'))
...
not_run: WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/div_Comprehensive Personal Liability'))

WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/div_Auto Liability'))

WebUI.setText(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/input_company name_companyName'), 
    'HMIC')

WebUI.setText(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/input_Limit Per Person_perPerson'), 
    '500,000')

WebUI.setText(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/input_Limit Per Accident_perAccident'), 
    '500,000')

WebUI.setText(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/input_Property Damage_propertyDamage'), 
    '100,000')

WebUI.setText(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/input_Combined Single Limit_combinedSingleLimit'), 
    '500,000')

WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/span_Save'))

WebUI.click(findTestObject('Object Repository/Quote/Page_HMIC Agency Portal - Personal Umbrella_400c25/span_Next Exposures'))
