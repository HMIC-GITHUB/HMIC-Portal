...
WebUI.click(findTestObject('PORTAL_HMIC/PORTAL_POLICY DETAILS/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_PolicyDetails_EntityType_Dropdown2'))
...
WebUI.click(findTestObject('Portal/Portal_PolDetails_Button_Save'))

WebUI.click(findTestObject('PORTAL_HMIC/PORTAL_POLICY DETAILS/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_PolicyDetails__NextLocations_Button2'))

WebUI.setText(findTestObject('Object Repository/Portal/Portal_Loc_TextBox_MaxNumOfEmp'), '51')

WebUI.click(findTestObject('Portal/Portal_Locations_TextBox_WorkClassification'))
...
WebUI.click(findTestObject('PORTAL_HMIC/PORTAL_QUOTE/Page_HMIC Agency Portal - Workers Compensation - Quote/Portal_Quote_SaveButton2'))
