...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_Address'), '3105 Grand Ave')
...
WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Chkbox_ExpRating'))
