...
not_run: WebUI.click(findTestObject('Portal/Portal_PolDetails_TextBox_SSN'))

not_run: WebUI.sendKeys(findTestObject('Portal/Portal_PolDetails_TextBox_SSN'), Keys.chord('123456789'))

not_run: WebUI.click(findTestObject('Portal/Portal_PolDetails_Button_Save'))
