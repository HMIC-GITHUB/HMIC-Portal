...
WebUI.click(findTestObject('TC3/Page_HMIC Agency Portal - Personal Umbrella_b16c8a/div_Michigan'))
...
WebUI.click(findTestObject('Quote/Page_HMIC Agency Portal - Personal Umbrella_c196ac/div_Genessee'))
...
WebUI.click(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/div_Please Select_css-1wy0on6'))

WebUI.click(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/div_Comprehensive Personal Liability'))

WebUI.setText(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/input_company name_companyName'), 
    'HMIC3')

WebUI.setText(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/input_Combined Single Limit_combinedSingleLimit'), 
    '500,000')

WebUI.click(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/button_Save'))

WebUI.click(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/span_Add Policy'))
...
WebUI.click(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/span_Save'))
...
WebUI.click(findTestObject('New Comprehensive Personal/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/Page_HMIC Agency Portal - Personal Umbrella - Primary Policy/span_Next Exposures'))
...
WebUI.click(findTestObject('Object Repository/TC3/Page_HMIC Agency Portal - Personal Umbrella_b16c8a/div_Please Select'))
